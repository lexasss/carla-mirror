...
def gaussian_filter1d(input, sigma, axis: int = ..., order: int = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., truncate: float = ...): ...
def gaussian_filter(input, sigma, order: int = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., truncate: float = ...): ...
...
def uniform_filter(input, size: int = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
...
def minimum_filter(input, size: Incomplete | None = ..., footprint: Incomplete | None = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
def maximum_filter(input, size: Incomplete | None = ..., footprint: Incomplete | None = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
def rank_filter(input, rank, size: Incomplete | None = ..., footprint: Incomplete | None = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
def median_filter(input, size: Incomplete | None = ..., footprint: Incomplete | None = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
def percentile_filter(input, percentile, size: Incomplete | None = ..., footprint: Incomplete | None = ..., output: Incomplete | None = ..., mode: str = ..., cval: float = ..., origin: int = ...): ...
